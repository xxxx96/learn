...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">男方姓氏：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"style="width: 30%" value="" placeholder="" id="" name="manSurname">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">女方姓氏：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"style="width: 30%" value="" placeholder="" id="" name="womanSurname">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="preface" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"></textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <script name="text" id="editor" type="text/plain" style="width:100%;height:400px;"></script>
            </div>
        </div>
        <div class="row cl">
    ...
    (function( $ ){
        ...
        $(function() {
                ...
                if ( file.getStatus() === 'invalid' ) {
                    ...
                    uploader.makeThumb( file, function( error, src ) {
                        ...
                        if( isSupportBase64 ) {
                            ...
                            $.ajax('<%=basePath%>lib/webuploader/0.1.5/server/preview.php', {
                                method: 'POST',
                                data: src,
                                dataType:'json'
            ...
            uploader.on( 'uploadSuccess', function( file,response ) {
                ...
                $("#pic_url").val($("#pic_url").val()+response.result+";");
                //alert($("#pic_url").val());
            })
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                if(data.code==1){
                    ...
                    $.Huimodalalert(data.result,2000);
                }
            },
            error: function (data) {
            }
